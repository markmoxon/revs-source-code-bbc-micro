...
\ L5500 = trackData+512
\ L5600 = trackData+768
\ L5700 = trackData+1024
\ L5800 = trackData+1280
\ 
\ L5900 = trackData+1536
\ L5901 = trackData+1537
\ L5902 = trackData+1538
\ L5903 = trackData+1539
\ L5904 = trackData+1540
\ L5905 = trackData+1541
\ L5906 = trackData+1542
\ L5907 = trackData+1543
...
.trackData
    ...
    EQUB &F8            \ trackData+208

    EQUB &52, &B2, &07, &FC, &D9, &28
    EQUB &FB, &CD, &27, &17, &30, &FA, &D2, &00

    EQUB &6C            \ trackData+224

    EQUB &04, &1B, &03
    EQUB &08, &4B, &3F, &0E, &FF, &B1, &35, &F0, &C5, &F0, &C7, &24

    EQUB &08            \ trackData+240

    EQUB &08, &08, &08, &00, &12, &11, &08, &08, &F0, &EC, &0C
    EQUB &16, &04, &F0, &08

    EQUB &FC            \ trackData+256

    EQUB &FE, &02, &06, &0A, &0E, &12, &15
    ...
    EQUB &78            \ trackData+768

    EQUB &78, &78, &78, &78, &77, &77, &76, &75, &74, &73, &72
    ...
    EQUB &A9            \ trackData+1024

    EQUB &A9, &A9, &A9, &A9, &A9, &AA, &AA
    ...
    EQUB &30            \ trackData+1536

    EQUB &20            \ trackData+1537

    EQUB &80            \ trackData+1538

    EQUB &A0            \ trackData+1539

    EQUB &C0            \ trackData+1540

    EQUB &00            \ trackData+1541

    EQUB &94            \ trackData+1542

    EQUB &63            \ trackData+1543
    ...
    EQUB &48, &00, &50, &52, &14, &33, &72, &3B, &18, &33, &15, &15
    EQUB &15, &3C, &18, &30, &33, &39, &38, &14, &14, &14, &37, &20
    EQUB &59, &2B, &54, &14, &14, &67, &03, &10, &19, &2C, &38, &4D
    EQUB &64, &75, &70, &70, &94, &98, &A4, &A8, &B5, &B8, &C0, &FF
    EQUB &00, &04, &4B, &03, &33, &29, &00, &01, &01, &00, &67, &00
    EQUB &67, &42, &35, &2E, &2A, &A1, &00, &A1, &68, &52, &48, &41
    EQUB &86, &92, &98, &04, &28, &18, &00, &73, &6F, &31, &00, &8C
    EQUB &00, &00, &60, &EA, &EA
